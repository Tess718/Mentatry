          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              <input
                ...
                aria-invalid={!isValidPassword && password.length > 0}
              />

              <button
                type="button"
                onClick={() => setShowPassword((prev) => !prev)}
                className="absolute right-3 text-slate-700 hover:text-black p-1"
            ...
            {password && (
              <div className="bg-slate-50 border-2 border-black p-3 text-xs space-y-1 font-semibold">
                <div className="font-black text-[10px] uppercase text-slate-500 mb-1">
                  Password Requirements:
                </div>

                <div
                  className={`flex items-center gap-1.5 ${
                    hasMinLength ? "text-lime-700 font-bold" : "text-slate-500"
                  }`}
                >
                ...
                <div
                  className={`flex items-center gap-1.5 ${
                    hasUpper ? "text-lime-700 font-bold" : "text-slate-500"
                  }`}
                >
                ...
                <div
                  className={`flex items-center gap-1.5 ${
                    hasLower ? "text-lime-700 font-bold" : "text-slate-500"
                  }`}
                >
                ...
                <div
                  className={`flex items-center gap-1.5 ${
                    hasNumber ? "text-lime-700 font-bold" : "text-slate-500"
                  }`}
                >
                ...
                <div
                  className={`flex items-center gap-1.5 ${
                    hasSpecial ? "text-lime-700 font-bold" : "text-slate-500"
                  }`}
                >
