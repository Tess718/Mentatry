...
export function NavbarClient({ user }: NavbarClientProps) {
  ...
  return (
    <>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {user ? (
            <>
              ...
              {/* Mobile Profile / Menu Trigger (< lg) */}
              <div className="flex lg:hidden items-center">
                <motion.button
                  whileTap={{ scale: 0.94 }}
                  type="button"
                  onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                  className="flex items-center gap-1.5 p-1 pl-1.5 pr-2 bg-slate-900 text-white hover:bg-slate-800 border-2 border-black rounded-xl shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] cursor-pointer"
                  aria-label="Toggle Mobile Menu"
                >
                  <Avatar seed={avatarSeed} size={26} className="shrink-0" />
      ...
      {/* 4. Full-Screen Viewport Portal Animated Mobile Navigation Drawer */}
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <div className="lg:hidden fixed inset-0 z-[9999] flex flex-col justify-start">
              ...
              {/* Sliding Navigation Container with Spring Physics */}
              <motion.div
                ...
                className="relative w-full bg-slate-950 border-b-4 border-black shadow-[0_16px_50px_rgba(0,0,0,0.95)] p-5 z-10 max-h-[85vh] overflow-y-auto"
              >
                {/* Header: Brand + Animated Close Button */}
                ...
                {user && (
                  <motion.div
                    ...
                    className="my-4 p-3 bg-slate-900 border-2 border-black rounded-xl flex items-center gap-3 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
                  >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Link
                          href="/explore"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="p-3 bg-violet-400 text-black border-2 border-black rounded-xl font-black text-xs uppercase flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 transition-transform active:scale-95"
                        >
                        ...
                        <Link
                          href="/daily"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="p-3 bg-cyan-400 text-black border-2 border-black rounded-xl font-black text-xs uppercase flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 transition-transform active:scale-95"
                        >
                        ...
                        <Link
                          href="/rooms/join"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="p-3 bg-pink-400 text-black border-2 border-black rounded-xl font-black text-xs uppercase flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 transition-transform active:scale-95"
                        >
                        ...
                        <Link
                          href="/quizzes/new"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="p-3 bg-lime-400 text-black border-2 border-black rounded-xl font-black text-xs uppercase flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 transition-transform active:scale-95"
                        >
                          <Plus className="w-4 h-4 stroke-[3]" />
                          <span>Create Quiz</span>
                        </Link>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Link
                          href="/quizzes"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="p-3 bg-amber-400 text-black border-2 border-black rounded-xl font-black text-xs uppercase flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 transition-transform active:scale-95"
                        >
                        ...
                        <Link
                          href="/achievements"
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="p-3 bg-yellow-300 text-black border-2 border-black rounded-xl font-black text-xs uppercase flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-y-0.5 transition-transform active:scale-95"
                        >
                  ...
                  >
                    ...
                    <div className="pt-3 border-t-2 border-slate-800 space-y-2">
                      <Link
                        href="/signup"
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="w-full p-3 neo-btn neo-btn-pink font-black text-xs uppercase flex items-center justify-center gap-2 active:scale-98"
                      >
                      ...
                      <Link
                        href="/login"
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="w-full p-3 neo-btn neo-btn-white font-black text-xs uppercase flex items-center justify-center gap-2 active:scale-98"
                      >
